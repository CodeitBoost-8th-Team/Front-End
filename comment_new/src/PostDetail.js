...
function PostDetail() {
  ...
  const addComment = (nickname, content) => {
    ...
    console.log('New comment added:', newComment); // 확인용 로그
    ...
    <div className="post-detail">
      ...
      <article className="post">
        ...
        <div className="post-body">
          <p>인천 앞바다에서 월척을 낚았습니다! 가족들과 기억에 오래도록 남을 멋진 하루였어요.</p>
        </div>
      </article>
      ...
      <CommentModal showModal={showModal} closeModal={closeModal} addComment={addComment} />
      {currentComment && (
        <CommentEdit
